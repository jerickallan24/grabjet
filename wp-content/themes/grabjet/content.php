...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'wpmice' ) ); ?>
		<?php
			wp_link_pages( array(
	...
	<footer class="entry-footer">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'wpmice' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'wpmice' ), __( '1 Comment', 'wpmice' ), __( '% Comments', 'wpmice' ) ); ?></span>
		<?php endif; ?>
